# Predict Industrial Production using FNETS applied to FRED-MD 
...
for (index in 1:n_backtest_days){
    ...
    predictions <- inverse_min_max_scaler_matrix(predictions_matrix,min_vals = X_train_min,max_vals = X_train_max) 
